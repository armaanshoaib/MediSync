  ...
  Widget build(BuildContext context) {
    ...
    if (DateTime(
      ...
      if (isTaken) {
        ...
        // Newly added medication for today should show 'Yet to Take'
        if (DateTime.now().hour < 23) {
          // Assuming the day isn't over yet
          takenTxt = 'Yet to Take';
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.quicksand(
                        ...
                        color: !isTaken
                            ? const Color.fromARGB(255, 236, 255, 0)
                            : const Color.fromARGB(255, 16, 15, 15),
                      ),
                    ),
                    //dosage
